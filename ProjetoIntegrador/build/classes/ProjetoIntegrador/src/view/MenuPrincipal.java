...
public class MenuPrincipal extends javax.swing.JFrame implements InternalFrameListener {
    ...
    private void initComponents() {
        ...
        jmiManuCliente.setText("ManuFunc");
      ...
      private void abrirManuCliente(){
        if(!flagGuiManutencaoCliente){
            GUIManutencaoFunc gmc = new GUIManutencaoFunc();
    ...
    public void internalFrameClosed(InternalFrameEvent ife) {
      //To change body of generated methods, choose Tools | Templates
       if (ife.getInternalFrame() instanceof GUICadFunc){
            flagGuiCadCliente = false;
       }else if (ife.getInternalFrame() instanceof GUIManutencaoFunc ){
